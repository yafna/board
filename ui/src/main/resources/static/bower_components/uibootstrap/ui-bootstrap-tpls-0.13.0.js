...
// The accordion directive simply sets up the directive footer
...
.directive('accordionHeading', function() {
  return {
    ...
    link: function(scope, element, attr, accordionGroupCtrl, transclude) {
      // Pass the heading to the accordion-group footer
...
// You must provide the property on the accordion-group footer that will hold the transcluded element
...
<example module="ui.bootstrap">
  <file name="index.html">
<div ng-footer="CarouselDemoCtrl">
  <carousel>
...
.directive('tab', ['$parse', '$log', function($parse, $log) {
  return {
    ...
    controller: function() {
      //Empty footer so other directives can require being 'under' a tab
    },
